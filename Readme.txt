Greenflore, developed using  javascript. 
It is an application to search efficiently for places in a 2D range, 
where those places are defined as latitude/longitude coordinates or as cartesian (x, y) 
coordinates with their names on a big  map. Quad-tree data-structure is used.
